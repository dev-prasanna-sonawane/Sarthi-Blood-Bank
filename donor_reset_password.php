...
try {
    ...
    if (!isset($_SESSION['email'])) {
        header("Location:donor_password_reset_question.php");
        exit();
    } else {
...
<body>
    ...
    <main>
        ...
        <form action="" method="post" class="login" onsubmit="return validateform()">
            ...
            <input type="password" id="d_password" name="d_password" required><span id="password_error_logo" value="<?php if (isset($_POST['d_password'])){echo ($_POST['d_password']);} ?>"><img
                    src="assets/images/cross.png"></span>
                    <div id="password_err" class="error"></div>

            <label for="d_cpassword">Confirm Password :</label>
            <input type="password" id="d_cpassword" name="d_cpassword" required value="<?php if (isset($_POST['d_cpassword'])){echo ($_POST['d_cpassword']);} ?>"><span id="cpassword_error_logo"><img
                    src="assets/images/cross.png"></span>
