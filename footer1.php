<nav id="f_navbar">
    <ul id="f1_nav_ul">
        <li id="about_us"><a class="f_nav_li f_links" href="about_us.php" style="color:var(--color);"><strong>About Us</strong></a><br>This Portal is dedicated to display<br> Information on Blood Donation Services.<br>ItProvides many features for Donors as well as Patients.<br>
            <p>
