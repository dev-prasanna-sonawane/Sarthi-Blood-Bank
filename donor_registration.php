  ...
  <main>
    ...
    <form id="donor_form" action="" method="post" onsubmit="return validateform()">
      ...
      <label for="d_name">Full Name :</label>
            <input type="text" id="d_name" name="d_name" required value="<?php if (isset($_POST['d_name'])){echo ($_POST['d_name']);} ?>" ><span id="name_error_logo"><img src="assets/images/cross.png"></span><div id="name_err" class="error"></div>  

            <label for="d_age">Age :</label>
            <input type="number" id="d_age" name="d_age" required value="<?php if (isset($_POST['d_age'])){echo ($_POST['d_age']);} ?>"><span id="age_error_logo"><img src="assets/images/cross.png"></span>
            ...
            <input type="text" id="d_address" name="d_address" value="<?php if (isset($_POST['d_address'])){echo ($_POST['d_address']);} ?>"></input>
            <div class="error"></div> 
