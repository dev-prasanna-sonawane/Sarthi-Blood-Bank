...
try {
    if (isset($_POST['d_update'])) {
        ...
        if ($conn->query($query)) {
            onlyAlertMessage('Donor Details Updated Successfully');
        } else {
            onlyAlertMessage('An Error occured while Updating Donor Details, Please Try Again!');
        }
    }
    ...
    <body>
        ...
        <main>
            ...
            <form id="dashboard" action="" method="post" onsubmit="return validateform()">
                ...
                <input type="text" id="d_password" name="d_password" required placeholder='Password is Hidden' ><span id="password_error_logo"><img src="assets/images/cross.png"></span>
                <div id="password_err" class="error"></div>

                <label for="d_cpassword">Confirm Password :</label>
                <input type="text" id="d_cpassword" name="d_cpassword" required placeholder="Password is Hidden"><span id="cpassword_error_logo"><img src="assets/images/cross.png"></span><div id="password_match_err" class="error"></div>
