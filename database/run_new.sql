...
-- 0. Create Database
CREATE DATABASE `sarthibloodbank_db`;
...
-- Creating Table
CREATE TABLE `sarthibloodbank_db`.`appointments` (`appointment_id` INT NOT NULL , `appointment_date` DATE NOT NULL ,`appointment_time` TIME NOT NULL,`donor_id` INT NOT NULL , `donor_name` VARCHAR(100) NOT NULL , `status` VARCHAR(50) NOT NULL ,`donated` VARCHAR(10)NOT NULL,`appointment_request_time` TIMESTAMP NOT NULL, PRIMARY KEY (`appointment_id`));
